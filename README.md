...
***Update: Windows Supported***
Thanks [@Meteony](https://github.com/Meteony) for testing on Windows. Run the following command to set up the environment. (Preferrably with conda.)
```bash
